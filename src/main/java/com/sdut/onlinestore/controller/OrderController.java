...
public class OrderController {
    ...
    public Result selectByPage(HttpServletRequest req,String uid) {
        return service.selectByPage(req,uid);
    }
    ...
    @GetMapping("/state")
    public Result comfirm(String oid, Integer state) {
        return service.setState(oid, state);
    }

    @ApiOperation(value = "用户付款修改订单状态, 后期可能修改该方法")
    @GetMapping("/pay")
    public Result userPay(String oid, Integer state) {
        return service.setState(oid, state);
    }
